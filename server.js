...
const controlNumberRoutes = require('./routes/controlNumberRoutes')
...
app.use('/api/controlNumber',controlNumberRoutes)
app.use('/api/invoiceNumber',invoiceNumberRoutes)
